api_addr = "https://192.168.100.3:9200"
cluster_addr = "https://192.168.100.3:9201"
ui = true
disable_mlock = "true"
...
listener "tcp" {
  ...
  tls_cert_file = "/certs/vault-2-cert.pem"
  tls_key_file  = "/certs/vault-2-key.pem"
}
...
storage "raft" {
  ...
  retry_join {
    ...
    leader_client_cert_file = "/certs/vault-2-cert.pem"
    leader_client_key_file  = "/certs/vault-2-key.pem"
  }
  retry_join {
